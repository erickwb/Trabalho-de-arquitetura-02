...
void B (char vet[], FILE *file2){
    int offset = 0;
    int aux = 0; //auxiliar para pegar os 3 primeiros bits do segundo numero
    aux = ((vet[1] & 7) << 8);
...
void B_condicional(char vet[], FILE *file2){
    int offset = 0;
    offset = (vet[2] << 4);
    offset = offset | vet[3];
    ...
    int condicao= 0; // condiçao do pulo
    condicao = vet[1];
